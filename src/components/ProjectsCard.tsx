              ...
              return (
                <span
                  className={`inline-flex items-center gap-x-1.5 py-1.5 px-3 rounded-full text-xs font-medium ${
                    (itm === "NextJS" && "bg-zinc-800 text-zinc-300") ||
                    (itm === "Javascript" &&
                      "bg-yellow-100 text-yellow-800 ") ||
                    (itm === "Typescript" && "bg-blue-100 text-blue-800") ||
                    (itm === "HTML" && "bg-red-100 text-red-800") ||
                    (itm === "ExpressJS" && "bg-stone-400 text-stone-100") ||
                    (itm === "Shadcn UI" && "bg-gray-700 text-gray-100") ||
